...
export default async function PaymentPage({
	...
	const successUrl = `${baseUrl}/tenant-domains/${params.tenant}/checkout/success?bookingId=${bookingId}&email=${encodeURIComponent(email)}`;
	const cancelUrl = `${baseUrl}/tenant-domains/${params.tenant}/checkout/payment?bookingId=${bookingId}&email=${encodeURIComponent(email)}`;
		...
		<div className="min-h-screen bg-background">
			...
			<div className="border-b">
				<div className="container mx-auto px-4 py-4">
					<Link
						href={`/tenant-domains/${params.tenant}/events`}
