...
export default function SignupPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			// Auth cookies are set server-side via Set-Cookie headers in the API response
			// Use window.location for a full page navigation so the browser processes the cookies
